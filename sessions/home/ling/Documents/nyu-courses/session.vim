...
silent only
cd ~/Documents/nyu-courses
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 nyu-courses.js
badd +11 server/server.js
badd +1 client/client.js
badd +9 nyu-courses.html
badd +11 ~/.vimrc
badd +2 lib/classes.js
badd +0 index.html
args nyu-courses.js
edit nyu-courses.js
