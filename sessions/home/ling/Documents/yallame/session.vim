...
set shortmess=aoO
badd +0 client/views/includes/threeSlides.litcoffee
badd +0 client/stylesheets/style.styl
badd +0 client/views/includes/rightbox.litcoffee
badd +0 client/views/includes/leftbox.litcoffee
badd +0 client/views/includes/feed.html
badd +0 client/views/includes/feed.litcoffee
silent! argdel *
edit client/views/includes/threeSlides.litcoffee
...
setlocal nolisp
setlocal nolist
setlocal makeprg=coffee\ -c\ --literate\ \ $*\ client/views/includes/threeSlides.litcoffee
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
setlocal nrformats=octal,hex
...
exe 'vert 1resize ' . ((&columns * 31 + 142) / 284)
exe 'vert 2resize ' . ((&columns * 252 + 142) / 284)
tabedit client/stylesheets/style.styl
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 93 - ((35 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
93
...
exe 'vert 1resize ' . ((&columns * 141 + 142) / 284)
exe 'vert 2resize ' . ((&columns * 142 + 142) / 284)
tabedit client/views/includes/rightbox.litcoffee
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
setlocal nolisp
setlocal nolist
setlocal makeprg=coffee\ -c\ --literate\ \ $*\ client/views/includes/rightbox.litcoffee
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
setlocal nrformats=octal,hex
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 22 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
...
wincmd w
argglobal
edit client/views/includes/leftbox.litcoffee
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-BS> <Plug>delimitMateS-BS
imap <buffer> <BS> <Plug>delimitMateBS
...
setlocal nolisp
setlocal nolist
setlocal makeprg=coffee\ -c\ --literate\ \ $*\ client/views/includes/leftbox.litcoffee
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
setlocal nrformats=octal,hex
...
exe '1resize ' . ((&lines * 34 + 36) / 72)
exe '2resize ' . ((&lines * 34 + 36) / 72)
tabedit client/views/includes/feed.html
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
wincmd w
argglobal
edit client/views/includes/feed.litcoffee
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-BS> <Plug>delimitMateS-BS
imap <buffer> <BS> <Plug>delimitMateBS
...
setlocal nolisp
setlocal nolist
setlocal makeprg=coffee\ -c\ --literate\ \ $*\ client/views/includes/feed.litcoffee
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
setlocal nrformats=octal,hex
