...
set shortmess=aoO
badd +0 client/views/communities/communities_create.litcoffee
silent! argdel *
edit client/views/communities/communities_create.litcoffee
...
setlocal nolisp
setlocal nolist
setlocal makeprg=coffee\ -c\ --literate\ \ $*\ client/views/communities/communities_create.litcoffee
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
...
silent! normal! zE
let s:l = 54 - ((37 * winheight(0) + 35) / 71)
