...
let s:cpo_save=&cpo
set cpo&vim
inoremap <silent> <Down> g<Down>
inoremap <silent> <Up> g<Up>
...
nmap <silent> \Z <Plug>ZenmodeToggle
...
silent only
cd ~/Documents/yallame
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +95 client/views/events/events_create.litcoffee
badd +260 server/fixtures.litcoffee
badd +19 client/stylesheets/style.styl
badd +0 client/main.html
badd +0 lib/collections/communities.litcoffee
badd +0 new
silent! argdel *
...
exe 'vert 1resize ' . ((&columns * 31 + 142) / 284)
exe 'vert 2resize ' . ((&columns * 252 + 142) / 284)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
nnoremap <buffer> <silent> gu :call nerdtree#invokeKeyMap("gu")
...
setlocal tabstop=2
setlocal tags=~/Documents/yallame/.git/nerdtree.tags,~/Documents/yallame/.git/tags,./tags,./TAGS,tags,TAGS
...
setlocal tabstop=2
setlocal tags=~/Documents/yallame/.git/stylus.tags,~/Documents/yallame/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal undolevels=-123456
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 101 + 142) / 284)
exe '2resize ' . ((&lines * 3 + 36) / 72)
exe 'vert 2resize ' . ((&columns * 80 + 142) / 284)
exe '3resize ' . ((&lines * 61 + 36) / 72)
exe 'vert 3resize ' . ((&columns * 80 + 142) / 284)
exe '4resize ' . ((&lines * 3 + 36) / 72)
exe 'vert 4resize ' . ((&columns * 80 + 142) / 284)
exe 'vert 5resize ' . ((&columns * 101 + 142) / 284)
argglobal
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
...
setlocal tabstop=2
setlocal tags=~/Documents/yallame/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal undolevels=-123456
...
wincmd w
argglobal
edit lib/collections/communities.litcoffee
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
setlocal nolisp
setlocal nolist
setlocal makeprg=coffee\ -c\ --literate\ \ $*\ lib/collections/communities.litcoffee
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
setlocal nrformats=octal,hex
...
setlocal tabstop=2
setlocal tags=~/Documents/yallame/.git/html.tags,~/Documents/yallame/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal undolevels=-123456
